...
const timer_cfg_t g_timer1_cfg =
{
    ...
    .channel             = 1,
    .p_callback          = gpt_timer1_callback,
...
const timer_cfg_t g_timer0_cfg =
{
    ...
    /* Actual period: 0.02 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0x1e8480, .duty_cycle_counts = 0xf4240, .source_div = (timer_source_div_t)0,
    .channel             = 0,
    .p_callback          = gpt_uart_callback,
    /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
sci_uart_instance_ctrl_t     g_uart2_esp8266_ctrl;

            baud_setting_t               g_uart2_esp8266_baud_setting =
            {
            ...
            /** UART extended configuration for UARTonSCI HAL driver */
            const sci_uart_extended_cfg_t g_uart2_esp8266_cfg_extend =
            {
                .clock                = SCI_UART_CLOCK_INT,
                .rx_edge_start          = SCI_UART_START_BIT_FALLING_EDGE,
                .noise_cancel         = SCI_UART_NOISE_CANCELLATION_DISABLE,
                .rx_fifo_trigger        = SCI_UART_RX_FIFO_TRIGGER_MAX,
                .p_baud_setting         = &g_uart2_esp8266_baud_setting,
                .flow_control           = SCI_UART_FLOW_CONTROL_RTS,
                #if 0xFF != 0xFF
                .flow_control_pin       = BSP_IO_PORT_FF_PIN_0xFF,
                #else
            ...
            /** UART interface configuration */
            const uart_cfg_t g_uart2_esp8266_cfg =
            {
                .channel             = 2,
                .data_bits           = UART_DATA_BITS_8,
                .parity              = UART_PARITY_OFF,
                .stop_bits           = UART_STOP_BITS_1,
                .p_callback          = esp8266_uart2_callback,
                .p_context           = NULL,
                .p_extend            = &g_uart2_esp8266_cfg_extend,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
                .p_transfer_tx       = NULL,
#else
...
/* Instance structure to use this module. */
const uart_instance_t g_uart2_esp8266 =
{
    .p_ctrl        = &g_uart2_esp8266_ctrl,
    .p_cfg         = &g_uart2_esp8266_cfg,
    .p_api         = &g_uart_on_sci
};
sci_uart_instance_ctrl_t     g_uart0_ctrl;
            ...
            const uart_cfg_t g_uart0_cfg =
            {
                ...
                .parity              = UART_PARITY_OFF,
                .stop_bits           = UART_STOP_BITS_1,
                .p_callback          = debug_uart0_callback,
                .p_context           = NULL,
